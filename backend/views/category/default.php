...
<table height="750px" border=0 align=left>
    <tr>
        <td align=left valign=top style="border-right: #999999 1px dashed">
            <div id="tree-one" class="tree tree-selectable ztree" style="width:200px; overflow:auto;"></div>
        </td>
        <td width=100% align=left valign=top>
            <iframe id="iframe_category" name="iframe_category" frameborder=0  width=99% height="" src="<?= Url::toRoute(['index']) ?>"></iframe>
        </td>
    </tr>
</table>
