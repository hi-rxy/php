...
class Database {
    ...
    private function open($size) {
        if ($this->fp) {
            ...
            if ($this->size > $this->config['part']) {
                ...
                $this->fp = null;
                $this->file['part'] ++;
                Yii::$app->cache->get('db_backup_file', $this->file);
                $this->create();
            }
        } else {
    ...
    public function create() {
        ...
        $sql .= "\n";
        $sql .= "Host     : ".Yii::$app->params['site']['MYSQL_HOST']." \n";
        $sql .= "Port     : ".Yii::$app->params['site']['MYSQL_PORT']." \n";
        $sql .= "Database : ".Yii::$app->params['site']['DATA_TABLE_NAME']." \n";
        $sql .= "\n";
